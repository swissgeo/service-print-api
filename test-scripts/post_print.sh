...
body=$(printf '{"print_format":"a3","print_orientation":"landscape","print_resolution":96,"print_scale":25000,"state_id":"%s","print_legend":true,"print_grid":false,"print_lang":"de"}' "${state_id}")
